...
import 'piccolore';
import { N as Navigation, $ as $$Layout } from '../../chunks/Navigation_Bs1NcDtb.mjs';
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const description = void 0;
  const canonicalUrl = `${SITE_URL}/blog/${id}`;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": pageTitle, "description": description, "ogType": "article", "ogUrl": canonicalUrl, "canonical": canonicalUrl, "articlePublishedTime": note?.created_at, "articleAuthor": note?.author }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="min-h-screen bg-slate-950 text-white"> ${renderComponent($$result2, "Navigation", Navigation, { "client:load": true, "client:component-hydration": "load", "client:component-path": "H:/Apps/citinet-info/src/app/components/Navigation", "client:component-export": "Navigation" })} <div class="max-w-2xl mx-auto px-6 pt-32 pb-24"> <a href="/blog" class="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-violet-400 transition-colors mb-12">
← All posts
