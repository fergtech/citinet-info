  ...
  return (
    <section id="cta" ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-emerald-950">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-32 text-center">
        ...
        >
          <button className="group px-10 py-5 bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-lg rounded-xl font-bold shadow-2xl shadow-cyan-500/40 hover:shadow-cyan-500/60 transition-all duration-300 hover:scale-105 flex items-center gap-3">
            Start a Hub
