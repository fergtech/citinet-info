...
export function NetworkExplainer() {
  ...
  const nodes = [
    ...
    },
    {
      icon: Globe,
      title: "Secure Tunnel",
      subtitle: "Public Access, Zero Exposure",
      description: "A permanent HTTPS tunnel (Tailscale Funnel, Cloudflare, or your own proxy) makes your hub reachable from anywhere — without port forwarding or giving anyone else your data.",
