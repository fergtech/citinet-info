...
import { BookOpen, Home, Flower2, GraduationCap, Building2, Users } from 'lucide-react';
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-6">
            ...
            <span className="bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">
              Communities Inside the Cloud
            </span>
          </h2>
          <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-8">
            Spaces let communities run groups, departments, clubs, classrooms, and projects — 
            each with discussions, files, events, and governance.
          </p>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <div className={`absolute inset-0 bg-gradient-to-br ${space.color} opacity-60 group-hover:opacity-70 transition-opacity`} />
                ...
                <div className="p-6">
                  ...
                  <p className="text-sm text-slate-400 mb-4 leading-relaxed">{space.description}</p>
                  <div className="px-3 py-1.5 bg-slate-800/50 rounded-lg border border-white/10 inline-block">
                    <code className="text-xs text-cyan-400 font-mono">{space.url}</code>
                  </div>
                </div>

                {/* Hover glow */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none">
                  <div className={`absolute inset-0 bg-gradient-to-br ${space.color} opacity-5 blur-xl`} />
                </div>
              </motion.div>
            );
          })}
